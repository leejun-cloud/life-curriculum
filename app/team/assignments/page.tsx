    ...
    <RoleGuard allowedRoles={["team_leader", "admin"]}>
      <div className="container mx-auto p-6 space-y-6">
        <div className="flex items-center justify-between">
          <div>
            <h1 className="text-3xl font-bold text-foreground">과제물 관리</h1>
            <p className="text-muted-foreground mt-2">팀원들의 과제물을 생성하고 관리하세요</p>
          </div>
          ...
          <Card className="border-primary/20">
            <CardHeader>
              <CardTitle className="flex items-center gap-2">
                <FileText className="w-5 h-5" />새 과제 생성
              </CardTitle>
            ...
            <CardContent className="space-y-4">
              ...
              <div className="flex gap-2 pt-4">
                <Button onClick={handleCreateAssignment} className="bg-primary hover:bg-primary/90">
